<template>
  <div class="ide-page" v-loading="loading" element-loading-background="rgba(8, 13, 24, .86)">
    ...
    <main :class="['workbench', `layout-${layoutMode}`]">
      ...
      <section class="editor-column" :style="{ gridTemplateRows: `38px minmax(280px,1fr) 20px ${terminalHeight}px` }">
        ...
        <div v-show="activePath && !markdownPreview" ref="editorRef" class="monaco-host"></div>
